...
groups are designed to support new folks to arrive, and to help old hands
branch out of their everyday connecting — an approachable point of contact for
everyone.
...
We meet for a short time at the same time each day to connect, share highlights,
reflect a little.
...
principle is that weaving is there to help people arrive and connect.
...
If you're hosting a group, see [HOSTING.md](./HOSTING.md) for how groups are
formed, session recipes, and a bank of prompts.
...
- see [HOSTING.md](./HOSTING.md) for more details on how to host
- see [emails/](./emails) for some email templates for organising
